...
public class weather4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather4);
    ...
    public void getweather4(View v){
        ...
        example.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                if(response.code()==404){
                    Toast.makeText(weather4.this,"SOMETHING WENT WRONG!!!",Toast.LENGTH_LONG).show();
                }
